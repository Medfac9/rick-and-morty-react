...
import { CharacterResult } from '../features/allCharacters/interface';

export default function Character({ character }: CharacterResult) {
          ...
          <div className="d-flex align-items-center justify-content-between">
            <div className="mr-3">
              ...
              <div className="text-muted small">
                ...
                <p>
                  Specie:
                  <FontAwesomeIcon icon={specieIcon} />
                </p>
              </div>
            </div>
